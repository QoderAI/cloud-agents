...
| --- | --- |
| MCP | `https://mcp.qoder.com/api/v1/mcp/servers/qca` |
| Managed HTTP | `https://api.qoder.com/api/v1/cloud` |
| Forward HTTP | `https://api.qoder.com/api/v1/forward` |
| SAT exchange | `https://openapi.qoder.sh/api/v1/serviceToken/exchange` |
| PAT settings | `https://qoder.com/cloud/pat-keys` |
| PAT alternative | `https://qoder.com/account/integrations` |
| Product | `https://qoder.com/cloud-agents` |
